...
1. Add a [dispatch flag in .github/workflows/dispatch.yml](https://github.com/NASA-IMPACT/veda-deploy/blob/dev/.github/workflows/dispatch.yml#L66) component you are adding. As in `DEPLOY_MY_COMONENT: ${{ github.event.inputs.DEPLOY_MY_COMPONENT }}`
